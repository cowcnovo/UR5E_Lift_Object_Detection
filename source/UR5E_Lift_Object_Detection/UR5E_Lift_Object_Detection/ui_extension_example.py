...
def some_public_function(x: int):
    print("[UR5E_Lift_Object_Detection] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[UR5E_Lift_Object_Detection] startup")
    ...
    def on_shutdown(self):
        print("[UR5E_Lift_Object_Detection] shutdown")